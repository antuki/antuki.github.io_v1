...
author: "Kim Antunez</br><small class='fab fa-twitter-square' title='Mon twitter'></small>
 antuki13"
date: "Technical Interview with Shopify </br>13 February 2020"
output:
...
## A data science project (1/4)

<center>
<i>« A data science project you have worked on yourself independently »</i>
</center>

</br> 

<center><img src="img/questions.png" height="200px"></img></center>

* <strike>Producing word embeddings with word2vec</strike>
* <strike>Web app: interactive graphs about a French opinion survey</strike>
* **COGugaison and CARTElette : R packages in open-source for manipulating French spatial databases produced at different dates.**

</br>

<center>
<i>« We want you to be able to explain the project inside and out. »</i>
</center>


---

## A data science project (2/4)

<center>Available online
<a href="http://dataviz.drees.solidarites-sante.gouv.fr/Barometre-DREES/"> here</a></center>

<center><img src="img/baro.png" height="450px"></img></center>

---

## A data science project (3/4)

<center><a href="https://antuki.github.io/COGugaison/"><img src="https://antuki.github.io/img/COGugaison_small.png" width="200"></a><a href="https://github.com/antuki/CARTElette"><img src="https://antuki.github.io/img/CARTElette_small.png" width="200"></a></center>

**COGugaison** is an R package for manipulating french spatial databases produced at different dates. 

**CARTElette** is a complement to the COGugaison package. The goal is to create geographical layers that correspond to the situation of the division of the French territories (France and Overseas) on the first January of each year. 
...
## A data science project (4/4)

<center><img src="img/doc_cog.png" height="450px"></img></center>
...
---
### Use map layers adapted to the data

<center><img src="img/repo_cartelette.png" height="200px"></center>

<center><img src="img/carte_millefeuille_v2.png" height="300px"></center>
